...
class BlockedUser(models.Model):
    ...
    class Meta:
        verbose_name = 'کاربر مسدود شده'
        verbose_name_plural = 'کاربرانی که مسدود شده اند'
...
class BlockedUserHistory(models.Model):
    ...
    class Meta:
        verbose_name = 'تاریخچه کاربر بلاک شده'
        verbose_name_plural = 'تاریخچه کاربران بلاک شده'
